...
class Solution:
    def judgeCircle(self, moves: str) -> bool:
        ...
        # if number of ups and down or right and left differ, it means the
        # robot is not in origin 0, 0

        return moves.count('R') == moves.count(
            'L') and moves.count('D') == moves.count('U')
